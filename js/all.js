...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","[P4F] Launcher System","Введение","Интерфейс","Установка","Launcher Configurator (LC)","Update Server (UpdSrv)","Connect Server","Настройка LC","Настройка Update Server (UpdSrv.exe)","Основные настройки","Редактор дизайна","Локализация сообщений","Основное обновление","Мини обновление","Настройки","Загрузка библиотек","Строка состояния","Журналирование ","Настройки и статистика "],
    DREX_NODE_LINKS: ["index.htm","_p4f__launcher_system.htm","vvedenie.htm","interfejs.htm","ustanovka.htm","launcher_configurator__lc_.htm","update_server__updsrv_.htm","connect_server.htm","nastrojka_lc.htm","nastrojka_update_server__updsrv_exe_.htm","osnovnye_nastrojki.htm","redaktor_dizajna.htm","lokalizatsiya_soobshchenij.htm","osnovnoe_obnovlenie.htm","mini_obnovlenie.htm","nastrojki.htm","zagruzka_bibliotek.htm","stroka_sostoyaniya.htm","zhurnalirovanie_.htm","nastrojki_i_statistika_.htm"],
    DREX_NODE_CHILD_START: [1,2,5,5,8,10,13,18,20,20,20,20,20,20,20,20,20,20,20,20],
    DREX_NODE_CHILD_END: [2,5,5,8,10,13,18,20,20,20,20,20,20,20,20,20,20,20,20,20],
    DREX_MENU_TYPE: 1,
